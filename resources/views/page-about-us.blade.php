...
{{--
  Slug: about-us — matches header link /about-us/
  Slug: about-us — відповідає посиланню в шапці /about-us/
--}}
    ...
    <div class="py-section max-w-7xl mx-auto px-4 sm:px-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div class="lg:col-span-5">
          ...
          @else
            <div class="aspect-square bg-gray-100 border border-gray-200 rounded-none" aria-hidden="true"></div>
          @endif
        </div>
      </div>
    </div>
